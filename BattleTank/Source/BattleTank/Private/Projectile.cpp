...
AProjectile::AProjectile()
{
	...
	ImpactBlast = CreateDefaultSubobject<UParticleSystemComponent>(FName("Impact Blast Particle System"));
...
void AProjectile::OnHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComponent, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	GetWorld()->GetTimerManager().SetTimer(TimerHandle, this, &AProjectile::DestroyProjectiles, DestroyDelay, false);
}

void AProjectile::DestroyProjectiles()
{
	Destroy();
}